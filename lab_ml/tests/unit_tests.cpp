...
std::cout << g.getEdgeWeight( p1_2, p2_0 ) << std::endl;
std::cout << g.getEdgeWeight( p1_1, p2_0 ) << std::endl;
std::cout << g.getEdgeWeight( p2_2, p1_0 ) << std::endl;
std::cout << g.getEdgeWeight( p2_1, p1_0 ) << std::endl;
